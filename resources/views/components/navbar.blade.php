<nav class="fixed-top navbar navbar-expand-lg transparente navbar-custom">
        ...
        <a class="ps-2 ynav navbar-brand" href="{{ route('welcome') }}"> <img class=" logo-custom" src="/image/logo,sito.png"
                ...
                alt="logo del sito"></a>
        <button class="me-2 navbar-toggler text-inst" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        ...
        <div class="collapse navbar-collapse justify-content-around" id="navbarSupportedContent">
            <ul class="navbar-nav  mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="ps-1 ynav nav-link dropdown-toggle text-inst" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Categorie
                    </a>
                ...
                <li class="nav-item">
                    <a class="ps-1 ynav nav-link" href="{{ route('chisiamo') }}">Our Team</a>
                </li>
                <li class="nav-item">
                ...
                @guest
                    <li class="nav-item">                        
                        <a class="ps-1 ynav nav-link" href="{{ route('register') }}">Accedi</a>                     
                    </li>
                @else
                    <li class="nav-item">
