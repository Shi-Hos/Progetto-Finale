        ...
        <div class="col-8 col-md-4">
            <form method="POST" action="{{route('article.update' , compact('article'))}}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input name="title" value="{{$article->title}}" type="text" class="form-control @error('title') is-invalid @enderror">
                  @error('title')
                ...
                <div class="mb-3">
                  ...
                  <input name="subtitle" value="{{$article->subtitle}}" type="text" class="form-control @error('subtitle') is-invalid @enderror">
                  @error('subtitle')
                  <div class="alert alert-danger">{{$message}}</div>
                  @enderror
                </div>
